    ...
    <>
      ...
      <Section className="pb-20">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="mt-4 inline-flex items-center justify-center rounded-full bg-accent px-6 py-3 text-sm text-accent-foreground hover:bg-accent/90 transition-colors shadow-soft"
        >
